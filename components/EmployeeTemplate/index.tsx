        ...
        <div className="w-dvw">
            ...
            <div className={`w-1/2 md:w-1/3 lg:w-1/4 bg-blue-600 h-dvh fixed top-0 transform transition-transform ${show ? "left-0" : "right-full"}`}>
                ...
                <div className="w-full relative">
                    ...
                    <div
                        className="absolute right-3 -top-5 cursor-pointer text-2xl font-bold text-white"
                ...
                <div className="w-full flex flex-col">
                    ...
                    <div
                        className="w-full rounded-md text-white p-3 font-semibold bg-rose-600 hover:bg-rose-500 cursor-pointer"
