...
const EditScehdule = (myProp: props) => {
    ...
    const openModal = () => {
        setShow(true)
        setDepartureLocation(myProp.item.departured_location)
        setDepartureTime(new Date(myProp.item.departured_time))
    ...
    return (
        <div>
            ...
            <button
                className="px-2 py-1 rounded-md text-white bg-sky-600 hover:bg-sky-500"
                type="button"
                onClick={() => openModal()}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="w-full p-3">
                        <div className="my-2 border rounded-md">
                            ...
                            <input type="text" id={`departured_location-${myProp.item.id}`}
                        ...
                        <div className="my-2 border rounded-md">
                            ...
                            <DatePicker
                                showTimeInput={true}
                                id={`departured_time-${myProp.item.id}`}
                                className="p-1 outline-none border-b w-full hover:border-b hover:border-b-sky-500"
                        ...
                        <div className="my-2 border rounded-md">
                            ...
                            <input type="text" id={`arrived_location-${myProp.item.id}`}
                        ...
                        <div className="my-2 border rounded-md">
                            ...
                            <DatePicker
                                showTimeInput={true}
                                id={`arrived_time-${myProp.item.id}`}
                                className="p-1 outline-none border-b w-full hover:border-b hover:border-b-sky-500"
                        ...
                        <div className="my-2 border rounded-md">
                            ...
                            <input type="number" id={`price-${myProp.item.price}`}
